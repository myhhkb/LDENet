...
def get_params():
    params = {
        'weight': 'runs/xiaorong_module/GEIT_DIMB_SEAM_FMIOU/yolo11/weights/best.pt',  # mbm-yolo
        # 'weight': 'runs/xiaorong_module/yolo11-GEIT/weights/best.pt',  # mbm-yolo
        # 'weight': 'runs/xiaorong_module/yolo11/weights/best.pt',# 11
        # 'weight': 'runs/YOLO11/yolo11-CSP-PMSFA/weights/best.pt',
        # 'weight': 'runs/YOLO12/yolo12-origin/weights/best.pt',
        'device': 'cuda:0',
        'layer': '15', # string
        'dataset': 'heatmap/DDSM-MIAS-V2.0/val/images',
        'num_images': 50,
        'save_path': 'heatmap/output'
    }
    return params
