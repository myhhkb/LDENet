...
from ultralytics.nn.extra_modules.Detect_Conv2Formers import Conv2Formers
...
DETECT_CLASS = (Detect, Detect_DyHead, Detect_AFPN_P2345, Detect_AFPN_P2345_Custom, Detect_AFPN_P345, Detect_AFPN_P345_Custom, Detect_Efficient, DetectAux, Detect_SEAM, Detect_MultiSEAM, 
                ...
                Detect_LSCD_LQE, Detect_Conv2Formers, Detect_dyt,)
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect, Detect_Conv2Formers)):
                return "detect"
